...
export default async function Page() {
    ...
    return (
        <AdminLayout><div className=" mx-auto p-6">
                ...
                <form className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="firstName"
                            defaultValue="Marc"
                            className="w-full px-3 py-2 border border-gray-300 rounded-md  -sm focus:outline-none focus:ring-[#00B0C860] focus:border-[#00B0C860]"
                        />
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                defaultValue="•••••••••••••••••••"
                                readOnly
                                className="w-full px-3 py-2 border border-gray-300 rounded-md  -sm bg-gray-100"
                            />
                            <button
                                type="button"
