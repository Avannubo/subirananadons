                    ...
                    <div className="container mx-auto max-w-6xl px-2 md:px-4">
                        <div className="grid grid-cols-2 grid-rows-2 gap-4 md:grid-cols-4 md:grid-rows-1 md:gap-8">
                            ...
                            <div className="flex flex-col items-center text-center p-4 md:p-6 rounded-lg transition-colors shadow-sm bg-white">
                                ...
                                <h3 className="text-sm md:text-md font-bold text-gray-700 mb-2">{t('feature1')}</h3>
                            </div>
                            {/* Feature 2 */}
                            <div className="flex flex-col items-center text-center p-4 md:p-6 rounded-lg transition-colors shadow-sm bg-white">
                                <div className="flex items-center justify-center mb-4 hover:rotate-360 transition-transform duration-300">
                                ...
                                <h3 className="text-sm md:text-md font-bold text-gray-700 mb-2">{t('feature2')}</h3>
                            </div>
                            {/* Feature 3 */}
                            <div className="flex flex-col items-center text-center p-4 md:p-6 rounded-lg transition-colors shadow-sm bg-white">
                                <div className="flex items-center justify-center mb-4 hover:rotate-360 transition-transform duration-300">
                                ...
                                <h3 className="text-sm md:text-md font-bold text-gray-700 mb-2">{t('feature3')}</h3>
                            </div>
                            {/* Feature 4 */}
                            <div className="flex flex-col items-center text-center p-4 md:p-6 rounded-lg transition-colors shadow-sm bg-white">
                                <div className="flex items-center justify-center mb-4 hover:rotate-360 transition-transform duration-300">
                                ...
                                <h3 className="text-sm md:text-md font-bold text-gray-700 mb-2">{t('feature4')}</h3>
                            </div>
                        </div>
                    </div>
                </div>
