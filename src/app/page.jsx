      ...
      <div className="w-full">
        <div className="w-full py-10 md:py-16 bg-white">
          <div className="container mx-auto max-w-6xl px-2 md:px-4">
            <div className="grid grid-cols-2 grid-rows-2 gap-4 md:grid-cols-4 md:grid-rows-1 md:gap-8">
              {/* Feature 1 */}
              <div className="flex flex-col items-center text-center p-4 md:p-6 rounded-lg transition-colors shadow-sm bg-white">
                ...
                <h3 className="text-sm md:text-md font-bold text-gray-700 mb-2">Crea llista</h3>
              </div>
              {/* Feature 2 */}
              <div className="flex flex-col items-center text-center p-4 md:p-6 rounded-lg transition-colors shadow-sm bg-white">
                <div className="flex items-center justify-center mb-4 hover:rotate-360 transition-transform duration-300">
                ...
                <h3 className="text-sm md:text-md font-bold text-gray-700 mb-2">Afegeix els teus favorits</h3>
              </div>
              {/* Feature 3 */}
              <div className="flex flex-col items-center text-center p-4 md:p-6 rounded-lg transition-colors shadow-sm bg-white">
                <div className="flex items-center justify-center mb-4 hover:rotate-360 transition-transform duration-300">
                ...
                <h3 className="text-sm md:text-md font-bold text-gray-700 mb-2">Comparteix la llista</h3>
              </div>
              {/* Feature 4 */}
              <div className="flex flex-col items-center text-center p-4 md:p-6 rounded-lg transition-colors shadow-sm bg-white">
                <div className="flex items-center justify-center mb-4 hover:rotate-360 transition-transform duration-300">
                ...
                <h3 className="text-sm md:text-md font-bold text-gray-700 mb-2">Rep els regals</h3>
              </div>
            </div>
          </div>
        </div>
