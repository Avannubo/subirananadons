    ...
    if (viewMode === 'grid') {
        ...
        return (
            <motion.div
                ...
                className="overflow-hidden flex flex-col items-center text-center h-full cursor-pointer group"
            ...
            >
                <div className="relative w-full h-64 mb-4">
                    ...
                    <div className="absolute bottom-2 left-2  flex items-center justify-center space-x-3  bg-opacity-0 group-hover:bg-opacity-70 opacity-0 group-hover:opacity-100 transition-all duration-300">
                        <HoverButton onClick={(e) => { e.stopPropagation(); alert('Added to cart: ' + product.name); /* Implement add to cart */ }}>
                        ...
                        <HoverButton onClick={(e) => {
                            e.stopPropagation();
                            setIsHovered(false); // Reset hover state before opening modal
        ...
        return (
            <motion.div
                ...
                exit={{ opacity: 0 }}
                transition={{ duration: 0.5 }}
                className="flex flex-row items-start text-left p-4 w-full overflow-hidden cursor-pointer group"
                onMouseEnter={() => setIsHovered(true)}
                onMouseLeave={() => setIsHovered(false)}
            >
                ...
                <div className="flex flex-col justify-start w-2/3">
                    ...
                    {/* Add other elements like Add to Cart button if needed */}
                </div>
            </motion.div>
        );
    }
