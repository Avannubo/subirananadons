...
export default function ModalTPV({ isOpen, onClose, orderData }) {
    ...
    const calcularFirma = () => {
        ...
        let data = {
            ...
            "DS_MERCHANT_URLOK": `${window.location.origin}/cart?success=true&order=${merchantOrder}`,
            "DS_MERCHANT_URLKO": `${window.location.origin}/cart?cancelled=true&order=${merchantOrder}`
        };
