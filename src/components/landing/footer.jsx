                        ...
                        <div className="flex flex-col items-center md:items-start">
                            <div className="mb-4 md:mb-6 w-full flex justify-center md:justify-start">
                                <Image
                                    ...
                                    width={160}
                                    height={60}
                                    className="w-[160px] md:w-[400px] h-auto"
                                />
                            </div>
                            {/* Socials from DB */}
                            <div className="flex justify-center items-center gap-8 mt-4 md:mt-6">
                                {/* Socials icons */}
                                ...
                                {whatsapp && (
                                    <Link href={`https://wa.me/${whatsapp}`} aria-label="WhatsApp" className="text-[#333] hover:text-[#00B0C8] transition-colors cursor-pointer" target="_blank" rel="noopener noreferrer">
                                        <svg className="w-12 h-12 text-gray-700 hover:text-[#00B0C8]" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
