    ...
    return (
        <div className="fixed top-0 z-50 w-full bg-white shadow-md px-2 md:px-5 py-3 md:py-5">
            <div className="flex flex-col justify-center w-full">
                <div className="w-full flex flex-row justify-between items-center gap-2 md:gap-0">
                    {/* Hamburger menu */}
                    <div className="flex justify-start items-center px-0 md:px-4 py-2 md:py-3 min-w-[48px] md:w-[120px]">
                        <MenuVertical />
                    </div>
                    {/* Logo */}
                    <Link href="/" className="flex justify-center items-center flex-1 min-w-0">
                        <Image
                    ...
                    <div className="flex justify-end items-center min-w-[48px] md:w-[120px] space-x-2 md:space-x-4 text-gray-700">
                        {/* Search Icon */}
