// Import Brands Script (CommonJS version)
// This script imports brand names from a CSV file to MongoDB
// Run with: node src/scripts/import-brands.cjs
...
const DB_NAME = process.env.MONGODB_DB || 'your_database_name'; // Replace with your database name
